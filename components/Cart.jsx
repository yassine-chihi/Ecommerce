...
const Cart = () => {
  ...
  const {totalPrice, setTotalQuantities, cartItems, setShowCart, toogleCartItemQuantity, onRemove} = useStateContext()
      ...
      <div className="cart-container">
        <button
          ...
          onClick={() => setShowCart(false)}>
            ...
            <span className='cart-num-items'>({setTotalQuantities} items)</span>
        </button>
